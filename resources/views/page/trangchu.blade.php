                ...
                <div class="bannercontainer">
                    <div>
                        <div style="margin-top: 6%;">
                            ...
                            @if ($gio < 5) <h3 style="text-align:center">Chào Du buổi sáng</h3>
                                @elseif ($gio > 22)
                                <h3 style="text-align:center">Chào Du buổi chiều</h3>
                                @else
                                <h3 style="text-align:center">Chào Du buổi tối</h3>
                                @endif
                        </div>
